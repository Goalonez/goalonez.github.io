...
- 卡，挂🪜也卡，打开时的加载页面图标停半天，膈应，其他都还不错。目前还是更倾向于Obsidian，数据在本地，掌握在自己手里，本地文件搜索也快。

### ~~🚫[Flomo](https://flomoapp.com/)~~

- 没有代码块，产品确实做的挺好的，只是我个人需求上滴答清单基本能平替，所以轻度体验后就放弃了。
...
### [Longshot](https://longshot.chitaner.com/zh-cn/)
- CleanShot大版本更新续订感觉意义不大，就切换了。
...
### [iTerm](https://iterm2.com/)（`option + X`）
- 终端
- 配置
     具体可以参考Blog
  > [Zsh配置](./Zsh配置)
